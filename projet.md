...
Le Projet:
Un mini jeux ou l'on devrais résoudre une série d'énigme ou quizz sur un sujet personnalisé. En utilisant du HTML, CSS et JavaScript. Le projet est de crée un quizz avec plusieurs questions avec pour thème la culture géèral pour rendre ce quizz accessible et divertissant pour le plus grand nombre.
